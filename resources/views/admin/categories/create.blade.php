...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-white font-display mb-1">Tambah Kategori</h1>
            <p class="text-sm text-gray-400">Buat kategori baru untuk pengelompokan artikel</p>
        </div>
    </div>
    ...
    <div class="form-card">
        <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required autofocus class="input-field" placeholder="Masukkan nama kategori...">
                @error('name')
