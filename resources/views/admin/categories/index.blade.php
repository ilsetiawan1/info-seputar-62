...
<div class="main-content-wrapper">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
        <div>
            <h1 class="text-2xl font-bold text-white font-display mb-1">Manajemen Kategori</h1>
            <p class="text-sm text-gray-500">Atur kategori untuk pengelompokan artikel</p>
        </div>
        <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center px-4 py-2.5 btn-action-primary text-sm font-bold rounded-xl whitespace-nowrap shadow-lg">
                    ...
                    <tr class="table-row">
                        ...
                        <td class="text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('admin.categories.edit', $category->id) }}" class="inline-flex items-center px-4 py-1.5 btn-action-outline text-[11px] font-bold rounded-lg uppercase tracking-wider">
                                    Edit
                                </a>
                    ...
                    <tr>
                        <td colspan="4" class="px-8 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-bold text-white mb-1">Belum Ada Kategori</h3>
                                <p class="text-sm text-gray-500 mb-4">Mulai dengan menambahkan kategori baru.</p>
                                <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center px-4 py-2 bg-white/10 hover:bg-white/20 text-white text-sm font-bold rounded-lg transition-colors">
                                    Tambah Kategori
                                </a>
                            </div>
                        </td>
