...
<section class="container-site" style="padding-top:3rem;padding-bottom:3rem;min-height:50vh;">
    <div class="card" style="padding:2rem;">
        <h1 class="font-display" style="font-size:2rem;font-weight:700;color:white;margin-bottom:1rem;">Dashboard Admin</h1>
        <p class="prose-content">Selamat datang, {{ auth()->user()->name }}. Ini adalah halaman khusus Admin (Phase 6 Preparation).</p>
